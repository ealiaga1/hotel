<h1 class="mb-4">Editar Categoría de Menú: <?php echo htmlspecialchars($category['nombre_categoria'] ?? ''); ?></h1>
...
<div class="card shadow-sm mb-4">
    ...
    <div class="card-body">
        <form action="/hotel_completo/public/restaurant/categories/edit/<?php echo htmlspecialchars($category['id_categoria_menu']); ?>" method="POST">
            <div class="mb-3">
