<h1 class="mb-4">Crear Nueva Reserva de Evento</h1>
...
<div class="card shadow-sm mb-4">
    ...
    <div class="card-body">
        <form id="conventionBookingForm" action="/hotel_completo/public/convention/create" method="POST">
            <!-- Sección de Contacto/Cliente -->
            <fieldset class="mb-4 p-3 border rounded">
                <legend class="float-none w-auto px-2 fs-5">Datos del Contacto (*)</legend>
                <div class="mb-3">
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" name="client_type_radio" id="clientTypeGuest" value="guest" checked>
                        <label class="form-check-label" for="clientTypeGuest">Huésped Existente</label>
                    </div>
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" name="client_type_radio" id="clientTypeExternal" value="external">
                ...
                <div id="guestFields">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="searchGuest" placeholder="Nombre, Apellido, Email o DNI">
            ...
            <fieldset class="mb-4 p-3 border rounded">
                        ...
                        <select class="form-select" id="id_sala" name="id_sala" required>
                            ...
                            <?php foreach ($conventionRooms as $room): ?>
                                <option value="<?php echo htmlspecialchars($room['id_sala']); ?>"
                                    ...
                                    <?php echo (isset($preselected_room_id) && $preselected_room_id == $room['id_sala']) ? 'selected' : ''; ?>>
                ...
                <div class="row">
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="date" class="form-control" id="fecha_evento" name="fecha_evento" value="<?php echo htmlspecialchars($preselected_date ?? ''); ?>" required>
                    </div>
                    <div class="col-md-4 mb-3">
                        <label for="hora_inicio" class="form-label">Hora Inicio</label>
                        <input type="time" class="form-control" id="hora_inicio" name="hora_inicio" value="<?php echo htmlspecialchars($preselected_start_time ?? ''); ?>" required>
                    </div>
                    <div class="col-md-4 mb-3">
                        <label for="hora_fin" class="form-label">Hora Fin</label>
                        <input type="time" class="form-control" id="hora_fin" name="hora_fin" value="<?php echo htmlspecialchars($preselected_end_time ?? ''); ?>" required>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-6 mb-3">
                        <label for="num_asistentes" class="form-label">Número de Asistentes</label>
                        <input type="number" class="form-control" id="num_asistentes" name="num_asistentes" min="1">
                    </div>
                    <div class="col-md-6 mb-3">
                ...
                <div class="mb-3">
                    ...
                    <input type="number" class="form-control" id="precio_total" name="precio_total" step="0.01" min="0" value="0.00">
            ...
            <fieldset class="mb-4 p-3 border rounded">
                ...
                <div class="table-responsive mt-3">
                    <table class="table table-bordered">
                        ...
                        <tbody id="servicesTableBody">
                            ...
                            <tr><td colspan="5" class="text-center">No hay servicios/equipos añadidos.</td></tr>
                        </tbody>
                        <tfoot>
                            <tr>
                ...
                <input type="hidden" name="event_services_json" id="eventServicesJson">
            </fieldset>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    let eventServices = []; // Array para almacenar los servicios del evento
    ...
    function toggleClientTypeFields() {
        if (clientTypeGuestRadio.checked) {
            ...
            nombreContactoInput.value = ''; // Limpiar si cambia de tipo
            ...
            selectedGuestDisplay.value = ''; // Limpiar huésped seleccionado
            idHuespedExistenteInput.value = '';
            searchGuestInput.value = ''; // Limpiar buscador
            ...
            telefonoContactoInput.setAttribute('required', 'required'); 
            emailContactoInput.removeAttribute('required'); // Por defecto, hacemos requerido el teléfono
        }
    }
    ...
    function renderServicesTable() {
        ...
        if (eventServices.length === 0) {
            ...
            eventServices.forEach((service, index) => {
                ...
                const subtotal = service.cantidad * service.service_price_unit;
                row.innerHTML = `
    ...
    addServiceBtn.addEventListener('click', function() {
        ...
        if (description && quantity > 0 && priceUnit >= 0) {
            eventServices.push({
                ...
                subtotal: quantity * priceUnit // Se recalculará en render, pero útil para añadir
            });
    ...
    // Búsqueda de Huéspedes para Cargo (si se implementa) - Reutiliza la misma función de búsqueda
    // let searchGuestChargeTimeout; // Si se necesita un buscador separado
    // searchGuestChargeInput.addEventListener('input', function() { ... });
